...
if($_FILES['upload_fd4']['size'] <= $maxFileSize) {
 	 ...
 	 if (move_uploaded_file($_FILES['upload_fd4']['tmp_name'], $uploadFile)) // Success Upload
    {
	   ...
	   {
		     $err_string = 	"Cannot upload file! A problem occured when upload."	;
	   }
    } else {
...
<td align="left" class="TrOdd"><input name="idno" type="text" id="idno" style="font-weight:bold" size="15" ></td>
</tr>
<tr>
<?php 
/*if($_POST['idno'])
